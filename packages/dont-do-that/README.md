...
In Claude Code, the hook stack registers automatically. In Codex, plugin hooks
do not run; the two operator correction skills (`/duh` and `/just-a-question`)
are available through the generated Codex adapter package.
