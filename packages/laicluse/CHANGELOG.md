...
- **`/laicluse:whats-new` is the marketplace-wide changelog reader.** With a
  ...
  Ported from `/leclause:whats-new`, which keeps working for plugins that
  remain on the legacy marketplace.
